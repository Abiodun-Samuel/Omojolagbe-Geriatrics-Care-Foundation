...
export function WhatsAppButton({
  ...
  return (
    <a
      ...
      className={cn(
        variant === "chip"
          ? "inline-flex items-center gap-2 rounded-pill bg-verify-500 px-5 py-3 text-[0.95rem] font-semibold text-white transition-[transform,background-color] duration-(--dur-fast) hover:-translate-y-0.5 hover:bg-verify-600"
...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full bg-verify-500 text-white shadow-pop transition-[transform,background-color] duration-(--dur-fast) hover:-translate-y-0.5 hover:bg-verify-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus motion-reduce:transition-none"
    >
