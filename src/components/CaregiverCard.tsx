  ...
  return (
    <article className="card flex h-full flex-col p-6">
      <div className="flex items-center gap-4">
        <span
          className="flex h-14 w-14 items-center justify-center rounded-full bg-[var(--color-ink-900)] font-display text-lg font-semibold text-[var(--color-brand-400)]"
          aria-hidden="true"
        >
          {initials}
        </span>
      ...
      <dl className="mt-4 flex flex-wrap gap-x-5 gap-y-1 text-sm text-[var(--color-ink-600)]">
      ...
      <p className="mt-4 flex-1 text-sm text-[var(--color-ink-700)]">
        {caregiver.bio}
      </p>
